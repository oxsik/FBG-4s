...
#define STRING_CONFIG_H_AUTHOR "(Sergey, FBG4S)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //FB4S
#define DEFAULT_bedKp 46.47
#define DEFAULT_bedKi 8.65
#define DEFAULT_bedKd 166.38
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (38)    // X point for Z homing when homing all axes (G28).
